          ...
          >
            ...
            >
              ...
              <template v-else-if="column.type === 'checkbox'">
                <el-space wrap>
                  <el-tag v-for="value in getValue(item, column)" :key="value">
              ...
              <template v-else-if="column.type === 'foreign'">
                ...
                <el-tag v-else>
                  {{ getForeignValue(item, column) }}
                  <el-icon
                    v-if="column.foreignOptions.view"
                    @click="handleForeignView(getValue(item, column), column)"
                  >
                    <extend />
                  </el-icon>
                </el-tag>
...
<script setup>
import { Extend } from 'icon-park-vue3';
...
const getTagType = (value) => {
  return { false: 'danger', true: 'success' }[!!value];
};
